...
python main.py fit \
	...
	--data.num_proc 128 \
	--data.tokenizer_name "/sc-scratch/sc-scratch-cc06-medbert/checkpoints/medbert-128/checkpoint" \
	--data.dont_overwrite_existing_dataset false \
	--data.batch_size 128 \
	--data.num_workers 16 \
	--data.max_seq_len 512 \
	--data.cache_path "/sc-scratch/sc-scratch-cc06-medbert/medbert/cache" \
	--model.hf_checkpoint "/sc-scratch/sc-scratch-cc06-medbert/checkpoints/medbert-128/checkpoint" \
	--model.warmup_steps 200 \
	--model.decay_steps 1363 \
	--model.lr 4e-3 \
	--model.tokenizer_name "/sc-scratch/sc-scratch-cc06-medbert/checkpoints/medbert-128/checkpoint" \
	--model.optimizer "lamb" \
	--model.huggingface_save_dir "/sc-scratch/sc-scratch-cc06-medbert/medbert/checkpoint-512" \
	...
	--trainer.default_root_dir "/sc-scratch/sc-scratch-cc06-medbert/medbert/logs-512" \
